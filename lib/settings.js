/**
 * Create a BrewPi Settings Object.
 *
 * This object stubs out the data structure to be populated
 * by the Arduino. The current settings below are for reference
 * and will be overwritten when the Arduino is polled.
 */

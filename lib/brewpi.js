...
var BrewPi = function(options) {
  ...
  // Below isn't right as it's instantiated automatically rather than through create.
  ...
  this.create = function(createCallback) {
    ...
    var brewPiConnector = this.brewPiConnector();
    ...
    this.attachConnectorEvents(brewPiConnector, createCallback);
